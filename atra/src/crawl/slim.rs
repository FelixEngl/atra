...
use crate::crawl::result::{CrawlResult, CrawlResultMeta};
use crate::data_holder::DataHolder;
use crate::warc::WarcSkipInstruction;
...
mod test {
    use camino::Utf8PathBuf;
    use crate::crawl::result::test::create_test_data;
    use crate::crawl::slim::{SlimCrawlResult, StoredDataHint};
    use crate::url::url_with_depth::UrlWithDepth;
    use crate::warc::WarcSkipInstruction;
    use crate::warc::skip_pointer::{WarcSkipPointer, WarcSkipPointerWithPath};
