...
macro_rules! create_setter {
    ...
    (general@$target: ident with $name: ident($self: ident)) => {
        ...
        paste::paste!{
            #[allow(dead_code)] #[inline] pub fn [<$name _string>](&mut $self, general: impl Into<String>) -> WarcHeaderResult {
                $self.$name(GeneralFieldValue::from_string(general)?)
            }
            #[allow(dead_code)] #[inline] pub fn [<$name _bytes>](&mut $self, general: Vec<u8>) -> WarcHeaderResult {
    ...
    (general@$target: ident with $name: ident($self: ident) and fn check($value: ident) $check_block: block) => {
        #[allow(dead_code)] pub fn $name(&mut $self, general: GeneralFieldValue) -> WarcHeaderResult {
    ...
    (uri@$target: ident with $name: ident($self: ident)  ) => {
        #[allow(dead_code)] pub fn $name(&mut $self, uri_like: UriLikeFieldValue) -> WarcHeaderResult {
        ...
        paste::paste!{
            #[allow(dead_code)] #[inline] pub fn [<$name _string>](&mut $self, general: impl Into<String>) -> WarcHeaderResult {
                $self.$name(UriLikeFieldValue::from_string(general)?)
            }
            #[allow(dead_code)] #[inline] pub fn [<$name _bytes>](&mut $self, general: Vec<u8>) -> WarcHeaderResult {
