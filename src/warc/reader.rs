...
use crate::warc::header::{RequiredFieldError, WarcHeader};
use crate::warc::parser::{parse_warc_header, peek_warc_version, WarcVersionPeek};
use crate::warc::states::State;
use crate::warc::reader::ReadTarget::Header;
...
impl<T> WarcCursor<T> {
    ...
    #[allow(dead_code)] pub fn backlog_shrink(&mut self) { self.backlog.shrink_to_fit() }

    #[allow(dead_code)] pub fn backlog_len(&self) -> usize {
        self.backlog.len()
    }

    #[allow(dead_code)] pub fn backlog_capacity(&self) -> usize {
